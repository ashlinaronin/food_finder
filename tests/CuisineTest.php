    ...
    */
    ...
    class CuisineTest extends PHPUnit_Framework_TestCase
    {
        ...
        function test_getRestaurants()
        {
            ...
            // $cuisine_spicy = false;
            // $cuisine_price = 5;
            $test_cuisine = new Cuisine("Lebanese", false, 5, null);
            $test_cuisine->save();

            $test_restaurant1 = new Restaurant("Ben's Bulkogi", 50, "eastside", true, 1, null);
            $test_restaurant1->save();
            var_dump($test_restaurant1);

            $test_restaurant2 = new Restaurant("Mario's Pizza Hole", 35, "Hole", false, 1, null);
