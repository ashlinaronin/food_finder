    ...
    */
    ...
    class CuisineTest extends PHPUnit_Framework_TestCase
    {
        ...
        function test_getRestaurants()
        {
            ...
            $test_restaurant1 = new Restaurant("Ben's Bulkogi", 50, "eastside", true, $test_cuisine->getId());
            $test_restaurant1->save();

            $test_restaurant2 = new Restaurant("Mario's Pizza Hole", 35, "Hole", false, $test_cuisine->getId());
